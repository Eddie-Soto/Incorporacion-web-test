<?php 
    ...
    if(!empty($kit) && $kit != 5006 && $kit != 5031 && $kit != 5002 && !empty($gender) && !empty($country)){
        $kit_influencer = true;
    }
    ...
    $options = "";
    $queryResult = $pdo->prepare("SELECT * FROM cat_shirts WHERE pais = '$country' AND genero = '$gender';");
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group" id="shirt-sample">
            <img src='img/shirts/<?php echo $country ?>.png' width='100%' name='shirt-sample'>
        </div>
        <div class="form-group">
...
<script>
    function showShirtSample(){
        ...
        divSample.innerHTML = "<img src='img/shirts/<?php echo $country ?>.png' width='100%' name='shirt-sample'>";
