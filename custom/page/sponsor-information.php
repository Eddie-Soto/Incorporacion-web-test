		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					<input type="text" class="form-control input-sponsor" id="code-sponsor" onkeyup="Search_sponsor(this.value);" onkeypress="return JustNumbers(event);" maxlength="12" placeholder="Ingresa aquí el código aquí" value="<?php echo $code ?>" <?php if(isset($_SESSION["sponsor"]) || isset($_SESSION["sponsorid"])){ ?> disabled="true" <?php }?> >
