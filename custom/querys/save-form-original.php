...
if($country == 1){
	if($type == 1 and $type_incorporate == 1){ // si es asesor y es persona natural
		if(isset($_SESSION["cou"])) {
				...
				if($ope < 1){
					echo "verifica el numero de archivos que debes subir en el paso 3 debes subir 1 archivo <br>";
		...
		if(isset($_SESSION["cou"])) {
				...
				$ope = $count1 - $_SESSION["cou"];
				if($ope < 5){
					echo "verifica el numero de archivos que debes subir en el paso 3 debes subir 5 archivos <br>";
					//echo "se han borrado hasta el momento".$_SESSION["cou"];
					//echo "<br>se deben subir: ".$count1;
					//echo "<br> la operacion da:".$ope;
					?>
		...
		if(isset($_SESSION["cou"])) {
				...
				$ope = $count1 - $_SESSION["cou"];
				if($ope < 4){
					echo "verifica el numero de archivos que debes subir en el paso 3 debes subir archivos <br>";
				//	echo "se han borrado hasta el momento".$_SESSION["cou"];
			//		echo "<br>se deben subir: ".$count1;
			//		echo "<br> la operacion da:".$ope;
					?>
...
/*SE AGERGA POR DEFECTO EL SPONSOR PARA PRUEBAS*/
	//$sponsor=123456;
}
...
if($result != true)
{
	...
	exit;
...

		{
			...
			elseif($type == 0 and $country == 1)  /*Enviar a T.v. para COL*/
			...
			}elseif($type == 0 and $country == 5)  /*Enviar a T.v. para COL*/

			{
			echo "1///https://nikkenlatam.com/interno/carrito-compras-test/login-integration-incorporate-apartado.php?email=" . base64_encode($email)."&item=5031";

			}
			elseif($type == 0 and $country == 6)  /*Enviar a T.v. para COL*/
			{
				echo "1///https://nikkenlatam.com/interno/carrito-compras-test/login-integration-incorporate-apartado.php?email=" . base64_encode($email)."&item=5031";

			}
			elseif($type == 0 and $country == 4)  /*Enviar a T.v. para COL*/
			{
				echo "1///https://nikkenlatam.com/interno/carrito-compras-test/login-integration-incorporate-apartado.php?email=" . base64_encode($email)."&item=5031";

			}
			elseif($type == 0 and $country == 7)  /*Enviar a T.v. para COL*/
			{
				echo "1///https://nikkenlatam.com/interno/carrito-compras-test/login-integration-incorporate-apartado.php?email=" . base64_encode($email)."&item=5031";
...

			{
				...
				//echo "1///https://mitiendanikken.com/mitiendanikken/auto/login/". base64_encode($email);

			}
			elseif($type == 0 and $country!=5) /*Enviar a arma tu entorno*/
			...
			elseif($type == 0 and $country!=6) /*Enviar a arma tu entorno*/
			...
			elseif($type == 0 and $country!=4) /*Enviar a arma tu entorno*/
			...
			elseif($type == 0 and $country!=7) /*Enviar a arma tu entorno*/
...
/*
			...
			if($type == 0 && $country == 1){
				echo "1///http://colsiniva.nikkenlatam.com/autologinc?sap_code=".base64_encode($code);
			...
			elseif($type == 1 && $country == 1 && $type_kit==5024){
				...
				echo "1///https://nikkenlatam.com/interno/carrito-compras-test/login-integration-incorporate.php?email=" . base64_encode($email)."&item=".$type_kit. "&item2=" . $playera;
			}

			elseif($type == 1 && $country != 1) 
			...
			elseif($type == 0 and $country == 7){
				echo "1///http://test.mitiendanikken.com/mitiendanikken/auto/login/". base64_encode($email);
			}
			elseif($type == 0 and $country == 4){
				echo "1///http://test.mitiendanikken.com/mitiendanikken/auto/login/". base64_encode($email);
			}
			elseif($type == 0 and $country == 6){
				echo "1///http://test.mitiendanikken.com/mitiendanikken/auto/login/". base64_encode($email);
			}
			elseif($type == 0 and $country!=1) 
			{
