...
?>
	...
	<script src="custom/js/custom-1.1.js?4.1.12"></script>
...
-->
	...
	<script>
		...
		View_residency(document.getElementById("country").value); /*Datos de residencia*/
		//View_residency(1); /*Datos de residencia*/

		View_identity(); /*Datos de residencia*/

		View_kit(1, country); /* Carga los kits */
