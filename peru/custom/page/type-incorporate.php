...
if($country == 3)
{
	$name_person_value = "Persona natural (Válido solo con DNI)";
	$name_company_bussiness_value = "Persona natural con negocio (Válido solo con ficha RUC, aplica para Extranjeros)";
	$name_company_value = "Empresa";
}
if($country == 4)
{
