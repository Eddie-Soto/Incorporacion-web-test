...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			<input type="text" name="number-account" id="number-account" onblur="Validate_account(this.value)" maxlength="14" class="form-control input-number-account" placeholder="<?php echo $name_number_account_value ?>" hidden="true">
		</div>
	</div>
	<?php 
	...
	else
	{
		...
		<div class="col-md-6">
			<div class="form-group">
				<input type="text" name="number-clabe-account" id="number-clabe-account" onblur="Validate_CCI(this.value)" onkeypress="javascript: return Disabled_space(event,this)" maxlength="20" class="form-control input-number-clabe-account <?php if($country == 8){ echo "required"; } ?>" placeholder="<?php echo $name_clabe_account_value ?>" hidden="true">
			</div>
		</div>
		<?php	
	}
