...
Asesor de Bienestar Independiente Influencer y me voy a incorporar bajo su código.</small></label>
	...
	<hr>
	<div class="col-sm-12">
		<label id="option-sponsor-two" hidden="true"><input type="radio" value="2" name="type-sponsor" id="option-sponsor-1" onclick="Opacity_type_sponsor();">&nbsp;<strong>Un Asesor de Bienestar Independiente Influencer me presentó NIKKEN</strong><br/><small>Conocí NIKKEN a través de un 
