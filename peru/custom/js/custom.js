...
function Catalog_residency_one(country)

{

    var value = document.getElementById("residency-two").value;
    ...
    $.ajax({
        ...
        url: 'custom/page/catalog-residency-one.php',
...
function Catalog_residency_two(country)

{

    var value = document.getElementById("residency-two").value;

    var value_one = document.getElementById("residency-three").value;
    ...
    $.ajax({
        ...
        url: 'custom/page/catalog-residency-two.php',

        data: 'country=' + country + '&value=' + value + '&value_one=' + value_one,
...

{
    ...
    var type_document = document.getElementById("type-document").value;
...

    {
...

        {
            ...
            View_alert("Lo sentimos, <strong>el DNI debe ser de 8 caracteres</strong>", "warning");
    ...
    if(type_document == 36 || type_document == 15)

    {
...

        {
            ...
            View_alert("Lo sentimos, <strong>el número de identificación debe ser de 11 caracteres</strong>", "warning");
...

        {
            ...
            View_alert("Lo sentimos, <strong>el número de documento solo puede contener números</strong>", "warning");
...
function Validate_cellular(value)
...
function Validate_bank(value)

{
/*el numbre clabe acount es el CCI*/
/*el number acocunt es el numero de cuenta*/
    if(value == 46)

    {

        document.getElementById("number-clabe-account").hidden = true;
        document.getElementById("number-account").hidden = false;
    ...
    {
        document.getElementById("number-clabe-account").hidden = false;
        document.getElementById("number-account").hidden = true;
...

{
...

    {
...

        {
            ...
            View_alert("Lo sentimos, <strong>el número de la cuenta debe ser de 14 digitos", "warning");
...

    {
...

        {
            ...
            View_alert("Lo sentimos, <strong>el número de la cuenta debe ser de 13 digitos", "warning");
...

{
...

    {
...

        {
            ...
            View_alert("Lo sentimos, <strong>el CII debe ser de 20 digitos", "warning");
...
function Validate_type_document(type_document)

{
...

    {
        ...
        $("#address").attr("placeholder", "Dirección fiscal");
    ...
    {
        $("#address").attr("placeholder", "Dirección de residencia");
...

{
 ...
 else if(value == "10")
    {
        ...
        document.location.href = "http://signup.nikkenlatam.com/";
...
function validar_identificacion(){
   ...
   $.ajax({
    ...
    success: function(resp){
        if(resp == 1){
            View_alert("Lo sentimos, <strong>el numero de identificación ya ha sido utilizado", "error");
...
$(function () {
...

    {
        ...
        var second_last_name = $form.find('.input-second-last-name').val(); // Apellidos

        if(second_last_name == undefined || second_last_name == 'undefined'){ second_last_name = ''; }
