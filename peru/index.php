...
<div class="form-group">
									...
									<div class="col-md-12 format-radio">
										...
										<div class="form-group radio_input">
											...
											<label><input type="radio" value="1" name="type" id="abi" checked onclick="View_identity(); View_upload_documents(); View_sponsor(); View_kit(1,3);">&nbsp;Asesor de Bienestar Independiente Influencer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
<?php
    if(!isset($_SESSION)) 
    { 
...
<?php if(isset($_SESSION["kit"])){ ?>  <?php }else{ ?>
											...
											<label ><input type="radio" value="0"    name="type" onclick="View_identity(); View_upload_documents(); View_sponsor(); View_kit(0,3);">&nbsp;Miembro de la Comunidad NIKKEN</label>
										<?php }  ?>
