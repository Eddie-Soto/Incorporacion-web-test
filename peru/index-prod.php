...
<div class="form-group">
												...
												<div class="styled-select">
													...
													<select class="required input-country" onchange="getDataShirt(); Verify_country(this.value); Type_person(this.value); View_residency(this.value); View_identity(); View_upload_documents();  View_sponsor(); View_kit(1,this.value);" name="country" id="country">
														...
														<option value="3" selected>Perú</option>
									...
									<div class="col-md-12 format-radio">
										...
										<div class="form-group radio_input">
											<!--CAMBIO ---->
											<label><input type="radio" value="1" name="type" checked onclick="View_identity(); View_upload_documents(); View_sponsor();View_kit(1,3);">&nbsp;Asesor de Bienestar Independiente Influencer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
...
if(!isset($_SESSION)) 
    { 
											...
											<label><input type="radio" value="0" <?php if(!isset($_SESSION)) 
    {  if($_SESSION["mokuteki"]==123456){  ?> disabled="true" <?php } }?>  name="type" onclick="View_identity(); View_upload_documents(); View_sponsor(); View_hide(); View_kit(0,3); ">&nbsp;Miembro de la Comunidad NIKKEN</label>
											<!--CAMBIO ---->
										</div>
	...
	<script src="custom/js/custom.js?3.0.3"></script>
	...
	<script>
		...
		Type_person(3); /*Tipo de persona*/

		View_names(3); /*Nombres según el tipo de persona*/

		View_residency(3); /*Datos de residencia*/
