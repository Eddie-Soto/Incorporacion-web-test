...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<input type="text" name="name-cotitular" onkeypress="return Only_Only_letter(event);" oncopy="return false" onpaste="return false" class="form-control required input-name-cotitular" maxlength="100" placeholder="Apellidos y nombres completos del Cotitular">
