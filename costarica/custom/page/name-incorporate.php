...
<div class="row">
	...
	if($type != 0)
	{
		...
		<div class="col-md-3">
			<div class="form-group">
				<input type="text" name="last-name" onkeypress="return Only_letter(event);" oncopy="return false" onpaste="return false" maxlength="50" class="form-control input-last-name required" placeholder="<?php echo $last_name_value ?>" value="<?php echo $last_name_nc ?>">
			</div>
		</div>
		<?php
	}
	...
	<div class="col-md-<?php echo $columns ?>">
		<div class="form-group">
<input type="text" name="name" onkeypress="return Only_letter(event);" oncopy="return false" onpaste="return false" <?php if($type == 0){?> maxlength="100" <?php }else{?> maxlength="50" <?php } ?>  class="form-control input-name required" placeholder="<?php echo $first_name_value ?>" value="<?php if($type_incorporate_nc == 0){ echo $last_name_nc; }else{ echo $first_name_nc;  } ?>">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
        ...
        date_input.datepicker({
        	...
        	else
        	{
		        if(Validate_birthday(birthday) < 18)
        		{
        			...
        			swal({
        				type: 'warning',
        				title: 'Lo sentimos, debes ser mayor de edad para inscribirte a NIKKEN',
        			});
        			document.getElementById('btn-continue').disabled = true;
        			return false;
        		}else if(Validate_birthday(birthday) > 90){
        			document.getElementById('validator-birthday').value = "";
        			swal({
        				type: 'warning',
        				title: 'Lo sentimos, debes ser menor a 90 años de edad para inscribirte a NIKKEN',
        			});
        			document.getElementById('btn-continue').disabled = true;
        			return false;
        		}
