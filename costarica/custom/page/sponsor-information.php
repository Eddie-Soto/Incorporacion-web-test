...
<div class="row">
	<div class="col-sm-12">
		<label id="option-sponsor-one"><input type="radio" value="1" name="type-sponsor" onclick="Opacity_type_sponsor();" checked <?php if(isset($_SESSION["sponsor"])){ ?> disabled="true" <?php }?> >&nbsp;<strong>Me voy a incorporar con un Asesor de Bienestar Independiente Influencer</strong><br/><small>Conocí NIKKEN a través de un 
Asesor de Bienestar Independiente Influencer y me voy a incorporar bajo su código.</small></label>
		<div class="row">
			<div class="col-sm-5">
	...
	<div class="col-sm-12" hidden="true">
		<label id="option-sponsor-two"><input type="radio" value="2" name="type-sponsor" id="option-sponsor-1" onclick="Opacity_type_sponsor();">&nbsp;<strong>Un Asesor de Bienestar Independiente Influencer me presentó NIKKEN</strong><br/><small>Conocí NIKKEN a través de un 
Asesor de Bienestar Independiente Influencer. Sin embargo, <u>no conozco su código</u>.</small></label>
		<br/><br/>
	</div>
	<div class="col-sm-12">
		<label id="option-sponsor-three"><input type="radio" value="3" name="type-sponsor" id="option-sponsor-2" <?php if(isset($_SESSION["mokuteki"])==123456){  ?> disabled="true" <?php } ?> onclick="Opacity_type_sponsor();">&nbsp;<strong>Supe de NIKKEN a través del sitio Web</strong><br/><small>Conocí NIKKEN al visitar su página Web o a través de una búsqueda en Internet y estoy muy interesado (a) en incorporarme.</small></label>
	</div>
</div>
...
<script>
	...
	<?php if($code != ""){ ?> setTimeout(Search_sponsor(<?php echo $code ?>), 1000); <?php } ?>
