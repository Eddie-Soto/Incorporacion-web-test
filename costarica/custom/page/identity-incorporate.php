...
<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			<input type="text" onkeypress="return Only_letter(event);" name="address" class="form-control required input-address" maxlength="100" placeholder="<?php echo $address_value ?>" value="<?php echo $address_nc ?>">
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<label style="font-size: 15px;">Deseo incorporarme con un Cotitular</label>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<label style="font-size: 15px;">Deseo ingresar mi información bancaria IBAN<small>(Necesaria para el pago de bonificaciones)</small></label>
				</div>
			</div>
		</div>
...
<script>
	...
	$('#type-document').on("change",function (e) {
		/* Cedula de identidad */
		if ($('#type-document').val()==10){
        	$('#number-document-one').val('');
			$('#number-document-one').attr('maxlength','9');
			$('#number-document-one').attr('minlength','9');
        }
        ...
        if ($('#type-document').val()==21){
			...
			$('#number-document-one').attr('minlength','11');
        }
        if ($('#type-document').val()==39){
        	$('#number-document-one').val('');
			$('#number-document-one').attr('maxlength','10');
			$('#number-document-one').attr('minlength','10');
		}
