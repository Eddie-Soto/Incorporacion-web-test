...
<div class="form-group">
												...
												<div class="styled-select">
													...
													<select class="required input-country" onchange="getDataShirt(); Verify_country(this.value); Type_person(this.value); View_residency(this.value); View_identity(); View_upload_documents();  View_sponsor(); View_kit(1,this.value);" name="country" id="country">
						...
						<label><input type="radio" value="1" name="type" checked onclick="View_identity(); View_upload_documents(); View_sponsor(); View_kit(1,8);">&nbsp;Asesor de Bienestar Independiente Influencer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
<?php if(!isset($_SESSION)) 
    { 
											...
											?>
						<label <?php if(!isset($_SESSION)) 
    {  if( $_SESSION["mokuteki"]==123456){  ?>  hidden="true" <?php  }}?>><input type="radio" value="0" <?php if(!isset($_SESSION)) 
    {   if( $_SESSION["mokuteki"]==123456){  ?> disabled="true" hidden="true" <?php  } }?> name="type" onclick="View_identity(); View_upload_documents(); View_sponsor(); View_hide(); View_kit(0,8);">&nbsp;Miembro de la Comunidad NIKKEN</label>
						<!--CAMBIO ---->
										</div>
	...
	<script src="custom/js/custom-1.1.js?6.0.8"></script>
	...
	<script>
		...
		function validate_document_one(){
			...
			if ($("#number_document_input_value").val() == 'Registro Federal de Contribuyentes (RFC)') {
		...
		Type_person(1); /*Tipo de persona*/

		View_names(1); /*Nombres según el tipo de persona*/

		View_residency(1); /*Datos de residencia*/
