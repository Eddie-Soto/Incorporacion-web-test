...
<ul>
	...
	if($type == 1)
	{
		...
		if($cotitular == 1)
		{
			...
			$concat = "<li>Anexar copia de Identificación co-titular (Por ambos lados)</li>";
			$counter_images++;
		}
	...
	if($type_incorporate == 0)
	{
		...
		{
            $concat = "";
			//$concat = $concat . "<li>Anexar INE del representante legal</li>";
            $concat = $concat . "<li>Anexar copia de identificación oficial del representante legal (Por ambos lados)</li>";
