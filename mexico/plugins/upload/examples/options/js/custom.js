$(document).ready(function() {
	...
	$('input[name="files"]').fileuploader({
        ...
        /*CAMBIOS MEX ARCHIVOS**/
       // extensions: ['jpg', 'jpeg', 'png', 'audio/mp3', 'text/plain'], // allowed extensions or types {Array}
        extensions: ['png', 'jpg', 'pdf', 'doc', 'docx'], // allowed extensions or types {Array}
        /*CAMBIOS MEX ARCHIVOS**/
        ...
        captions: {
            ...
            errors: {
                ...
                filesType: 'Unicamente puedes subir archivos con las siguientes extensiones ${extensions}.',
