...
<head>
	...
	<meta name="description" content="Formulario de inscripción a NIKKEN Latinoamérica como Asesor de Bienestar Independiente o Club de Bienestar.">

	<meta name="author" content="NIKKEN Latinoamérica">

	<title>Incorporación Web | NIKKEN Latinoamérica</title>
	...
	<link href="custom/css/custom.css?2.0.0" rel="stylesheet">
						...
						<div class="col-lg-5">
							...
							<div id="left_form">
								...
								<p>
									...
									<ul class="format-ul" align="left">
										...
										if(isset($_SESSION["products"]))
										{
											...
											<li><strong><u>Si eres persona física los requisitos son:</u></strong></li>

											<li>-Identificación Oficial (Pasaporte o INE)</li>

											<li>- Información de datos fiscales (RFC)</li><br><br>

											<li><strong><u>Si eres persona moral los requisitos son:</u></strong></li>

											<li>-Identificación oficial del representante legal de la empresa</li>

											<li>-Información de datos fiscales (RFC) </li>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<a class='img-responsive flotante' target="_blank" href='https://wa.me/51989079782' ><img src='img/whatsapp.png' width="40px" height="40px" border="0"/></a>
									</div>
									<div class="col-md-4">
								...
								<form name="example-1" id="wrapped" method="POST">
									...
									<div id="middle-wizard">
										...
										<div class="col-md-4">
											...
											<button class="btn btn-outline-success" id="returnov" onclick="OVCountry();" hidden="true">Regresar a la Oficina Virtual</button-->
												<!--a href="https://nikkenlatam.com/interno/nikkenlatam-test/oficina-virtual/colombia/" class="btn btn-success">Regresar a la Oficina Virtual</a-->
												<!--a title="Tienda Virtual" href="https://test.mitiendanikken.com/"><img src="img/tienda.png" id="title" class="img-fluid" width="100px" height="45px"></a-->
										<!--/div>
										<div class="col-md-4">
										...
										<div class="col-md-12 ">
											<div class="form-group">
												...
												<div class="styled-select">
													...
													<select class="required input-country" onchange="getDataShirt(); Verify_country(this.value); Type_person(this.value); View_residency(this.value); View_identity(); View_upload_documents();  View_sponsor(); View_kit(1,this.value);" name="country" id="country" <?php 
...
<?php if(isset($_SESSION["kit"])){ ?>  <?php }else{ ?>
											<label><input  type="radio" value="0" name="type" <?php if(isset($_SESSION["products"]))
											{
												?> checked <?php } ?> onclick=" Type_billing(this.value,2); View_identity(); View_upload_documents(); View_sponsor();  View_hide(); View_kit(0,2);">&nbsp;Miembro de la Comunidad NIKKEN <?php if(isset($_SESSION["products"]))
												{
													?> <br/><small><p>Para NIKKEN un miembro de la comunidad significa que eres un cliente preferente, el cual <u> puede
														...
														Además, tienes las siguientes ventajas:<br>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Tu siguiente compra puedes realizarla de forma más rápida y segura.<br>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Guarda tus direcciones de envío.<br>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Puedes revisar tu historial de compras.<br>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Puedes visualizar las facturas generadas en formato PDF y XML.<br>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Aseguras recibir asesoría del Influencer de Bienestar.</p></small><?php } ?></label>
													<?php } ?>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<label id="option-billing-yes"><input type="radio" value="1" name="billing-type" id="billing-1" onclick="Facturacion(this.value); View_identity_invoice();" checked="true">&nbsp;<strong>Quiero registrar mis datos fiscales</strong></label>
														<br/><br/>
													</div>
													<div class="col-sm-12">
														<label id="option-billing-no"><input type="radio" value="0" name="billing-type" id="billing-2" onclick="Facturacion(this.value); View_identity_invoice();">&nbsp;<strong>No quiero registrar mis datos fiscales</strong></label>
													</div>
										...
										<div id="residency-incorporate"></div>

										<div id="show-playeras"></div>
									...
									<div class="step">
										...
										<h3 class="main_question"><strong>Paso 3/4</strong>Carga tus documentos</h3>



										<div id="view-upload-document"></div>
									...
									<div class="submit step">
										...
										<h3 class="main_question"><strong>Paso 4/4</strong>¿Cómo conociste a NIKKEN?</h3>



										<div id="view-sponsor"></div>
		...
		<footer id="home" class="clearfix">
			...
			<ul>
				...
				<li><a href="http://vivenikken.s3.amazonaws.com/pdf/others/Regional/Terms+and+conditions.pdf" target="_blank" class="animated_link">Términos y condiciones</a></li>

				<li><a href="https://nikkenlatam.com/" target="_blank" class="animated_link">Contáctenos</a></li>
		...
		<script src="plugins/upload/src/jquery.fileuploader.js" type="text/javascript"></script>
		...
		<script>
			...
			//alert(types);
			if(types!=0){
				var kit = document.getElementById('type-kit').value;
...
/*
		...
		*/
		...
		View_residency(2); /*Datos de residencia*/
		<?php 

		if(isset($_SESSION["products"]))
		{
			?>
			View_kit(0,2); /*Kits de inicio miembro*/
		<?php }else{ ?>

			View_kit(1,2); /*Kits de inicio unlfuencia*/
		<?php } ?>

		View_identity(); /*Datos de residencia*/

		View_upload_documents(); /*Carga de documentos*/
